...
recap %>%
  gt::gt() %>%
  gt::tab_header(
    title = "Comparaison des variables entre les bases Welfare du Sénégal ent 2018 et en 2021",
...
Table1 <- welfare_combined %>%
  ...
  modify_header(label = "**Profil sociodémographique et économique des ménages au Sénégal en 2018 et 2021**") %>%
...
ggplot(welfare_combined, aes(x = as.factor(year), y = pcexp)) +
  geom_boxplot() + 
  labs(title = "Boxplot du Revenu par Année au Sénégal", x = "année", y = "dépense")
