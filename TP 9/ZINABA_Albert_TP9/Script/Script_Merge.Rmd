...
```{r}
#Revisualisation dans la base 2018
data_welf2018 %>%
  to_factor() %>% #labéliser
  select(hnation) %>% #selection des variables qui vont s'afficher
  tbl_summary(missing = "always", #afficher les valeurs manquantes
...
#Revisualisation dans la base 2021
data_welf2021 %>%
  to_factor() %>% #labéliser
  select(hnation) %>% #selection des variables qui vont s'afficher
  tbl_summary(missing = "always", #afficher les valeurs manquantes
...
data_welf2018 %>%
  to_factor() %>% #labéliser
  select(hdiploma) %>% #selection des variables qui vont s'afficher
  tbl_summary(missing = "always", #afficher les valeurs manquantes
              missing_text = "Valeurs manquantes")
...
data_welf2018 %>%
  to_factor() %>% #labéliser
  select(hcsp) %>% #selection des variables qui vont s'afficher
  tbl_summary(missing = "always", #afficher les valeurs manquantes
              missing_text = "Valeurs manquantes")
...
data_welf2018 %>%
  to_factor() %>% #labéliser
  select(hbranch) %>% #selection des variables qui vont s'afficher
  tbl_summary(missing = "always", #afficher les valeurs manquantes
              missing_text = "Valeurs manquantes")
...
data_welf2018 %>%
  to_factor() %>% #labéliser
  select(region) %>% #selection des variables qui vont s'afficher
  tbl_summary(missing = "always", #afficher les valeurs manquantes
              missing_text = "Valeurs manquantes")
...
data_welf_final <- dplyr::bind_rows(data_welf2018, data_welf2021)
data_welf_final
...
data_welf_final %>%    
  ...
  as_gt() %>%
  gt::tab_header(title = "Statistiques sur certaines variables apres fusion") %>% 
