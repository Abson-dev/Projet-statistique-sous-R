...
ehcvm_raw <- haven::read_dta("../Donnees/s00_me_ner2021.dta")  # Chargement de la base de données EHCVM (format Stata)
hdx_raw <- readxl::read_excel("../Donnees/ner_admgz_ignn_20230720.xlsx") # Chargement de la base de données HDX (format Excel)
...
ehcvm_raw <- haven::read_dta("../Donnees/s00_me_bfa2021.dta") # Chargement de la base de données EHCVM (format Stata)
shape_raw <- readxl::read_excel("../Donnees/bfa_adminboundaries_tabulardata.xlsx", sheet = "ADM3") # Chargement de la base de données HDX (format Excel)
...
ehcvm_final <- ehcvm_shape_final %>%
  dplyr::select(-commune_clean, -departement_clean.x, -departement_clean.y, -departement_clean, -commune_label, -departement_label)
