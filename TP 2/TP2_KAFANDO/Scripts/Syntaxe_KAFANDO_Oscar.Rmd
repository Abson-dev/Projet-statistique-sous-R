...
**Différents type de merge**
  ...
  * - *full_join()* : Conserve toutes les lignes des deux tables, qu'il y ait correspondance ou non. Les valeurs manquantes sont remplies par NA. Toutes les deux bases doivent etre de la même nature (nbre de ligne)
